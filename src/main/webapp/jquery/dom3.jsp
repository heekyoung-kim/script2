...
<script type="text/javascript">
	...
	// 월을 선택하면 자동으로 해당 월에 맞는 날짜들이 선택되게 하기
	// 월별 마지막날을 나타내는 배열이다.
	var dates = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];

	// 월과 날을 표시하는 select엘리먼트를 미리 검색해둔다.
	// jQuery결과집합객체가 들어있는 변수명은 앞에 $를 붙이는게 암묵적인 개발자들의 룰.
